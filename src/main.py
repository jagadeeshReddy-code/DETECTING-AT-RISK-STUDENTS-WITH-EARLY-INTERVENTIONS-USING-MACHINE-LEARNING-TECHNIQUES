...
font1 = ('times', 13, 'bold')
uploadButton = Button(main, text="Upload Student Dataset", command=upload, bg='skyblue')
uploadButton.place(x=50,y=530)
uploadButton.config(font=font1)  

processButton = Button(main, text="Preprocess & PCA Feature Selection", command=preprocess, bg='skyblue')
processButton.place(x=270,y=530)
processButton.config(font=font1) 

rfButton1 = Button(main, text="Run Random Forest Algorithm", command=runRF, bg='skyblue')
rfButton1.place(x=600,y=530)
rfButton1.config(font=font1) 

lrButton = Button(main, text="Run Generalized Linear Model Algorithm", command=runGLM, bg='skyblue')
lrButton.place(x=890,y=530)
lrButton.config(font=font1) 

gbButton = Button(main, text="Run Gradient Boosting Machine Algorithm", command=runGBM, bg='skyblue')
gbButton.place(x=50,y=580)
gbButton.config(font=font1) 

mlpButton = Button(main, text="Run MLP Algorithm", command=runMLP, bg='skyblue')
mlpButton.place(x=400,y=580)
mlpButton.config(font=font1)

ffButton = Button(main, text="Run Feed Forward Neural Network", command=runFeedForward, bg='skyblue')
ffButton.place(x=600,y=580)
ffButton.config(font=font1)

graphButton = Button(main, text="Accuracy Graph", command=graph, bg='skyblue')
graphButton.place(x=890,y=580)
graphButton.config(font=font1)

predictButton = Button(main, text="Risk Prediction", command=predict, bg='skyblue')
predictButton.place(x=1040,y=580)
